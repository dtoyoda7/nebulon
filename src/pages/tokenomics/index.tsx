                ...
                <div>
                    ...
                    <div className="mt-5 grid sm:grid-cols-1 lg:grid-cols-2 gap-20">
                        <div>
                            ...
                            <img className="w-full h-3/6" src={require("../../assets/images/DEXView.jpg")} alt="" />
                            <div className="mt-5">
                                <p className="text-md lg:text-xl font-medium text-center">Our token will launch on the BSC chain. Only 1 Billion tokens will be issued.</p>
                        ...
                        <div>
                            ...
                            <img className="w-full h-3/6" src={require("../../assets/images/TLP Tokenomics.png")} alt="" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 mt-28">
                        <div className="flex items-center">
                            <img className="w-full lg:h-96" src={require("../../assets/images/TLP6.png")} alt="" />
                        </div>
                        <div className="flex flex-col justify-center">
                            ...
                            <p className="text-md lg:text-xl font-normal text-center mt-10">Put your $TRUST token to work by locking it in the staking dapp and earn a share 35% of Trust Launchpad's net income.</p>
                        </div>
                    </div>
                </div>
