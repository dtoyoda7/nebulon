                    ...
                    <div className="mt-10 lg:mt-0 grid grid-cols-1 lg:grid-rows-3 gap-10 lg:gap-20">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20">
                            <div className="flex items-center">
                                <img className="w-full lg:h-96" src={require("../../assets/images/TLP10.png")} alt="" />
                            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
                            ...
                            <div className="flex items-center">
                                <img className="w-full lg:h-96" src={require("../../assets/images/TLP1.png")} alt="" />
                            </div>
                        </div>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20">
                            <div>
                                <img className="w-full lg:h-96" src={require("../../assets/images/TLP2.png")} alt="" />
                            </div>
                            <div className="flex flex-col justify-center">
                ...
                <div className="pt-10 lg:pt-20">
                    ...
                    <div className="lg:flex justify-center mt-10">
                        <div className="flex flex-col justify-center items-center my-8 mx-10">
                            <img className="rounded-full mb-5 w-60 lg:w-96" src={require("../../assets/images/TLP8.png")} alt="" />
                            <div className="m-auto flex flex-col items-center w-full lg:w-[400px]">
                                ...
                                <button className="px-8 py-4 rounded-md bg-[#FFF] text-black font-semibold uppercase">Join Telegram</button>
                            </div>
                        </div>
                        <div className="flex flex-col justify-center items-center my-8 mx-10">
                            <img className="rounded-full mb-5 w-60 lg:w-96" src={require("../../assets/images/TLP5.png")} alt="" />
                            <div className="m-auto flex flex-col items-center w-full lg:w-[220px]">
                                <p className="text-center lg:text-4xl font-semibold">X(Twitter)</p>
                                <p className="text-center lg:text-xl my-10">Keep up to date with our PR and Marketing Join the conversation.</p>
                                <button className="px-8 py-4 rounded-md bg-[#FFF] text-black font-semibold uppercase">Follow Us</button>
                            </div>
                        </div>
                    </div>
                </div>
