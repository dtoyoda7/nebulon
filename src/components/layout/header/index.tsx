            ...
            <div className="px-4 lg:px-40 flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <Link to="/home" className="uppercase cursor-pointer font-normal block py-2 px-3 text-white rounded hover:font-semibold md:border-0 md:p-0" aria-current="page">Home</Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link to="/faps" className="uppercase cursor-pointer font-normal block py-2 px-3 text-white rounded hover:font-semibold md:border-0 md:p-0">FAQs</Link>
                        </li>
                        <li>
